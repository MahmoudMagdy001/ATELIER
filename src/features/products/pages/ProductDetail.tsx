...
import type { LimitedEdition, ProductVariant, SiteSettings } from '../../../types/database'
...
export default function ProductDetail() {
  ...
  useEffect(() => {
    async function loadProduct() {
      ...
      try {
        ...
        console.warn('Failed to load product:', (err as Error)?.message || err)
      } finally {
        setLoading(false)
      }
    }
  ...
  const galleryImages = useMemo<GalleryImageItem[]>(() => {
    ...
    const findVariantForImage = (imgUrl: string): ProductVariant | null => {
  ...
  const handleSelectGalleryImage = (item: GalleryImageItem) => {
