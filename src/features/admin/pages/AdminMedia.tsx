  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E6E1DC] pb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#141110]">مكتبة الوسائط السحابية (Media Library)</h1>
          <p className="text-xs text-[#8C7F75] mt-1">تخزين، ضغط WebP تلقائي، وإدارة صور ومستندات أتيليه</p>
        </div>

        {/* Upload Button */}
        <div>
          <label className="px-5 py-2.5 rounded-xl bg-[#C4A070] text-white hover:bg-[#B88F48] text-xs font-bold flex items-center gap-2 cursor-pointer transition-all shadow-md shadow-[#C4A070]/20">
            ...
            <div
              ...
              className={`group relative bg-white rounded-2xl border overflow-hidden cursor-pointer transition-all ${
                selectedMedia?.id === item.id
                  ? 'border-[#C4A070] ring-2 ring-[#C4A070]/20 shadow-md'
                  : 'border-[#E6E1DC] hover:border-[#C4A070]/50'
              }`}
            >
              ...
              <div className="absolute top-2 left-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                <button
                  ...
                  className="p-1.5 bg-black/70 hover:bg-[#C4A070] text-white rounded-lg text-[10px]"
                  title="نسخ الرابط"
                >
      ...
      {selectedMedia && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4" data-modal="light">
          <div className="bg-white rounded-2xl p-6 shadow-2xl max-w-2xl w-full border border-[#E6E1DC] space-y-4" dir="rtl">
            <div className="flex items-center justify-between border-b border-[#E6E1DC] pb-3">
              <h3 className="font-bold text-base text-[#141110]">تفاصيل ومعلومات الصورة</h3>
              <button onClick={() => setSelectedMedia(null)} className="text-[#8C7F75] hover:text-[#141110]">
              ...
              <form onSubmit={handleSaveMetadata} className="space-y-3">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] text-[#C4A070] font-medium">يتغير تلقائياً في كافة الأماكن</span>
                  </div>
                  <input
                    type="text"
                    required
                    className="w-full px-3 py-2 rounded-xl border border-[#E6E1DC] text-xs font-bold text-[#141110] bg-white placeholder-[#8C7F75] focus:border-[#C4A070] focus:outline-none"
                    value={metaName}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      type="text"
                      readOnly
                      className="w-full px-3 py-1.5 rounded-lg border border-[#E6E1DC] text-xs font-mono text-[#141110] bg-[#FAF8F5]"
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-[#FAF8F5] border border-[#E6E1DC] hover:bg-[#E6E1DC] rounded-lg text-xs font-bold text-[#141110]"
                    >
