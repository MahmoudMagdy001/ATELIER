...
export default function LuxuryStatsSection() {
  ...
  return (
    <motion.section 
      ...
      aria-labelledby="luxury-stats-heading"
    >
            ...
            {stats.map((stat, idx) => {
              ...
              return (
                <motion.div 
                  ...
                  className="group relative p-8 md:p-10 flex flex-col justify-between items-center text-center transition-colors duration-300"
                >
                  {/* Top Icon Badge */}
