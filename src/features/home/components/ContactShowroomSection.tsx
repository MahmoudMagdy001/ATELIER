...
import { FaLocationDot, FaPhone, FaClock, FaWhatsapp } from 'react-icons/fa6'
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 pb-8 border-b border-[#C4A070]/15">
          <div className="text-start">
            <h2 id="contact-showroom-heading" className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-[#F2EFE8]">
              {t('section_title_pre', 'زيارة')} <span className="gold-gradient-text">{t('section_title_highlight', 'صالة العرض')}</span>
            </h2>
          </div>
          ...
          <a
            ...
            className="inline-flex items-center justify-center self-start lg:self-auto px-6 py-2.5 rounded-full border border-[#C4A070]/40 text-xs font-bold text-[#C4A070] hover:bg-[#C4A070] hover:text-[#141110] transition-all duration-300"
          >
