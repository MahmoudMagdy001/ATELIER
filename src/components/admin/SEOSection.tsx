          ...
          <div className="border-t border-[#E6E1DC] pt-5 space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <textarea
                  rows={2}
                  className="w-full rounded-xl border border-[#E6E1DC] bg-white px-4 py-2 text-xs font-medium text-[#14110F] placeholder-[#8C7F75] focus:border-[#C5A880] focus:outline-none transition-all"
